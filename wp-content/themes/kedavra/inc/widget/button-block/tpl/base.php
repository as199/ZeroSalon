<?php
	...
	$button_anim 		= $instance['button_anim'];
	$anim_button_delay 	= $instance['anim_button_delay'];

$classes = array();
if( !empty($instance['design']['hover']) ) $classes[] = 'ow-button-hover';
?>
<div class="ow-button-base ow-button-align-<?php echo esc_attr($instance['design']['align']) ?> wow <?php echo sanitize_text_field( $button_anim ); ?>" data-wow-delay="<?php echo sanitize_text_field( $anim_button_delay ); ?>s">
	...
	<a <?php foreach($button_attributes as $name => $val) echo sanitize_text_field( $name ) . '="' . $val . '" ' ?>>
		<span>
			<?php
